...
function image_maker($number,$amount,$date,$protocol,$i){
   ...
   // imagepng($image);
   if (!file_exists("sandwich_angel_new/info_layer_$i")) {
    mkdir("sandwich_angel_new/info_layer_$i", 0777, true);
}
    $save = "sandwich_angel_new/info_layer_$i/".strtolower("info_layer_$i") .".png";
    imagepng($image, $save);
}
?>